            ...
            @foreach($books as $item)
                <div class="bg-white rounded-xl shadow p-4 flex flex-col justify-between h-full">
                    ...
                    <div class="w-full h-48 bg-gray-100 rounded-md overflow-hidden mb-4">
                        @if($item->cover)
                            <img src="{{ asset('storage/' . $item->cover) }}" class="object-cover w-full h-full">
                        @else
                    ...
                    <div class="space-y-1 mb-3">
                        ...
                        <span class="inline-block text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full">{{ $item->kategori }}</span>
                    ...
                    <div class="text-sm text-gray-600 space-y-1">
                        ...
                        <p>Stok: {{ $item->jumlah_stok }} | Rak: {{ $item->lokasi_rak }}</p>
                    </div>
                    <!-- Tombol -->
                    <div class="mt-4">
