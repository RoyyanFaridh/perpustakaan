    ...
    <div class="bg-white p-6 rounded-2xl shadow-md overflow-x-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex gap-2">
                <a href="<?php echo e(route('export.guru')); ?>" target="_blank" class="bg-green-500 hover:bg-green-600 text-white text-sm font-medium py-2 px-4 rounded-lg">
                    Export Excel
                </a>
...
<?php /**PATH D:\Perkuliahan Duniawi\New folder\New folder\perpustakaan\resources\views/livewire/admin/anggota/guru.blade.php ENDPATH**/ ?>