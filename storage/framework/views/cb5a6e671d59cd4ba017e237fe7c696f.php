        ...
        <table class="min-w-full text-sm text-left text-gray-700 border border-gray-200 rounded-lg overflow-hidden">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-3 font-semibold">NIS/NIP</th>
            ...
            <!--[if BLOCK]><![endif]--><?php if($listPeminjaman && $listPeminjaman->isNotEmpty()): ?>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $listPeminjaman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2"><?php echo e($item->anggota->nis ?? $item->anggota->nip); ?></td>
...
<<<<<<<< HEAD:storage/framework/views/3c1efff549cf9a0159fa8f7140332895.php
<?php /**PATH C:\Users\ACER\perpustakaan\resources\views/livewire/admin/peminjaman/index.blade.php ENDPATH**/ ?>
========
<?php /**PATH C:\Users\MSI Computer\Herd\perpustakaan\resources\views/livewire/user/peminjaman/index.blade.php ENDPATH**/ ?>
>>>>>>>> origin/putri:storage/framework/views/cb5a6e671d59cd4ba017e237fe7c696f.php
