        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
            <div class="bg-white rounded-xl shadow-lg w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
                ...
                <div class="space-y-4 text-sm text-gray-600">
                    ...
                    <!-- NIS atau NIP -->
                    <div>
                        <!--[if BLOCK]><![endif]--><?php if($role === 'siswa'): ?>
            ...
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-3 font-semibold">
                        <!--[if BLOCK]><![endif]--><?php if($role === 'guru'): ?> NIP
                        <?php elseif($role === 'siswa'): ?> NIS
                        <?php else: ?> Nomor Induk
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </th>
...
<?php /**PATH D:\Perkuliahan Duniawi\New folder\New folder\perpustakaan\resources\views/livewire/admin/anggota/index.blade.php ENDPATH**/ ?>