...
<div class="bg-white border border-gray-100 shadow-xs rounded-2xl p-4 w-full md:w-[calc(25%-1rem)]">
    ...
    <div class="flex justify-between items-center mt-4">
        ...
        <!--[if BLOCK]><![endif]--><?php if(!is_null($delta)): ?>
            <span class="text-sm font-medium rounded-md px-2 py-0.5 
                <?php echo e($delta >= 0 ? 'bg-green-100 text-green-600 border border-green-500' : 'bg-red-100 text-red-600 border border-red-500'); ?>">
