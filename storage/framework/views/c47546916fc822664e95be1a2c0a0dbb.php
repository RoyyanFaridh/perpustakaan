<div class="p-6 space-y-6 w-full">
    ...
    <div class="bg-white shadow-md rounded-xl p-6 space-y-4">
        ...
        <!--[if BLOCK]><![endif]--><?php if(session()->has('message')): ?>
            <div class="p-3 rounded bg-green-100 text-green-700"><?php echo e(session('message')); ?></div>
                ...
                <div class="flex gap-4">
                    <div class="w-[140px] h-[200px] flex-shrink-0 overflow-hidden rounded-md">
                        <!--[if BLOCK]><![endif]--><?php if($item->cover): ?>
                            <img src="<?php echo e(asset('storage/' . $item->cover)); ?>"
                    ...
                    <div class="flex flex-col justify-between flex-1 overflow-hidden">
                        <div>
                            <h3 class="text-lg font-bold text-black truncate" title="<?php echo e($item->judul); ?>"><?php echo e($item->judul); ?></h3>
                            ...
                            <p class="text-sm text-gray-500 mb-3 line-clamp-3 break-words"><?php echo e($item->deskripsi); ?></p>
                        </div>
